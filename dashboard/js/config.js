function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/no_shrinkage/contents/dashboard/data/no_shrinkage/cellData?ref=main',
            geneData: 'https://api.github.com/repos/acycliq/no_shrinkage/contents/dashboard/data/no_shrinkage/geneData?ref=main',
            // cellCoords: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_cell_2279/cellCoords?ref=master',
            cellEllipsoid: 'https://api.github.com/repos/acycliq/no_shrinkage/contents/dashboard/data/no_shrinkage/cellEllipsoid?ref=main',
